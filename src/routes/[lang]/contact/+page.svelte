...
<style>
    ...
    .right-panel {
        ...
        border-right: 1px solid rgba(62, 155, 69, 0.1);
    }

    .right-panel {
        border-right: none;
        border-left: 1px solid rgba(62, 155, 69, 0.1);
    }
    ...
    .logo {
        ...
        justify-content: space-between; /* symmetrical spacing */
        gap: 1rem;
        margin-top: 1rem;
    }
    .logo img {
    ...
    footer {
        ...
        border-top: 2px solid rgba(62, 155, 69, 0.2);
        padding: 1rem;
        text-align: center;
        grid-column: 1 / -1;
    }
