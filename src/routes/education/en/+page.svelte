  ...
  "text": " We craft transformative learning experiences that honor both the complexity of ideas and the simplicity of human curiosity. Every program is an invitation to grow.",
  "cta_1": {
    "url": "/services",
  ...
  "header": "Where knowledge meets human connection"
};
  ...
  "title": "Learning is a conversation, not a broadcast",
  "description": "We reject the industrial approach to education. Instead, we create spaces where curiosity is honored, questions are welcomed, and growth happens at the intersection of challenge and support.  Every learner brings wisdom. Every challenge offers invitation. Every moment of confusion is an opportunity for clarity."
};
    ...
    <div class="service-layout">
      {#each items as item}
        <div class="service-card">
          ...
          <a href={item.cta.url} class="service-link">{item.cta.label}</a>
        </div>
      {/each}
    </div>
  </section>
...
.service-card:nth-child(1) { border-left-color: var(--sage); }
.service-card:nth-child(2) { border-left-color: var(--soft-orange); }
.service-card:nth-child(3) { border-left-color: var(--beige); }
.service-card:nth-child(4) { border-left-color: #C4A77D; }
