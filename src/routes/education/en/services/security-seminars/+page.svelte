  ...
  "items": [
    ...
    {
      "tag": "GDPR Compliance Training"
    },
    {
      "tag": "Corporate Cybersecurity Workshops"
    }
  ],
  "title": "Security Seminars",
  "number": "SERVICE / 01",
  "subtitle": "From cybersecurity awareness to GDPR compliance, we design seminars that turn your workforce into your first line of defense.",
  "data_number": "01"
};
  ...
  "intro": "In a world where cyber threats evolve every single day, your people are both your greatest vulnerability and your strongest defense. Firewalls, antiviruses, and encryption systems can only go so far. A single careless click can undo millions in security investment.",
  "items": [
    {
  ...
  "texts": [
    {
      "intro_text": "STOLON's Security Seminars are designed to prevent that from happening by transforming your workforce into a resilient human firewall. We believe that cybersecurity starts with awareness. Our programs focus on building practical habits and a shared sense of responsibility across your entire organization."
    },
    {
      "intro_text": "From entry-level employees to top executives, every participant learns how to identify, prevent, and respond to security risks before they escalate."
    }
  ],
  "title": "What We Cover",
  ...
  "items": [
    {
      "title": "Phishing Awareness Recognizing and responding to sophisticated email attacks and social engineering tactics\n\nRecognizing and responding to sophisticated email attacks and social engineering tactics",
      "description": "Recognizing and responding to sophisticated email attacks and social engineering tactics"
    },
    {
      "title": "Password Security",
      "description": "Creating and managing secure credentials that protect critical systems"
    },
    {
      "title": "Device & Wi-Fi Safety",
      "description": "Securing mobile devices and understanding network vulnerabilities"
    },
    {
      "title": "GDPR Compliance",
      "description": "Handling personal data with legal precision and ethical responsibility"
    },
    {
      "title": "Incident Reporting",
      "description": "Fast, effective communication when threats are detected"
    },
    {
      "title": "Sector-Specific Risks",
      "description": "Insider threats, supply chain attacks, and industrial espionage"
    }
  ],
  "title": "What We Cover"
};
